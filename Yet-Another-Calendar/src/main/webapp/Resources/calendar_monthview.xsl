...
<xsl:stylesheet version="1.0"
				...
				<div id="main">
					...
					<div id="calendar">
						<div id="tabbar">
							...
							<div class="tab selected">Monatsansicht
							<xsl:value-of select="year/month[@number=//calendar/@selectedmonth]/@name"></xsl:value-of>
							</div>
				...
				<xsl:for-each
					...
					<div class="monthday" style="width: {$width}; height: {$height};">
						<div class="monthdaycontent">
							<div class="daynumber"><xsl:value-of select="@number"></xsl:value-of></div>
	...
	<xsl:template match="entry">
		<div class="monthentry" style="background-color: #{@color}">
			<xsl:value-of select="starttime/@hours"></xsl:value-of>:<xsl:value-of select="starttime/@minutes"></xsl:value-of> Uhr
