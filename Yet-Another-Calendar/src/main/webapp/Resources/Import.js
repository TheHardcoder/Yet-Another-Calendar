...
function showFileOpenDialog () {
	...
	elem.innerHTML = '<form method="post" enctype="multipart/form-data" style="position: absolute; z-index: 10; left: 50%; margin-left: -250px; margin-top: 50px; width: 500px; height: 150px; padding: 10px; background-color: #A65E00;">' +
